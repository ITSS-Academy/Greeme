...
export declare class MapComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MapComponent, "smart-map, [smart-map]", ["smart-map"], { "apiKey": "apiKey"; "query": "query"; "mode": "mode"; "mapType": "mapType"; "heading": "heading"; "pitch": "pitch"; "zoom": "zoom"; }, {}, never>;
}
