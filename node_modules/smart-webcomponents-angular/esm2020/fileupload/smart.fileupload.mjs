...
FileUploadComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FileUploadComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
FileUploadComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: FileUploadComponent, selector: "smart-file-upload, [smart-file-upload]", inputs: { accept: "accept", animation: "animation", appendTo: "appendTo", autoUpload: "autoUpload", directory: "directory", disabled: "disabled", dropZone: "dropZone", hideFooter: "hideFooter", itemTemplate: "itemTemplate", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", multiple: "multiple", name: "name", readonly: "readonly", responseHandler: "responseHandler", rightToLeft: "rightToLeft", setHeaders: "setHeaders", showProgress: "showProgress", theme: "theme", uploadUrl: "uploadUrl", unfocusable: "unfocusable", removeUrl: "removeUrl", value: "value", validateFile: "validateFile" }, outputs: { onFileSelected: "onFileSelected", onUploadCanceled: "onUploadCanceled", onUploadCompleted: "onUploadCompleted", onUploadError: "onUploadError", onUploadPaused: "onUploadPaused", onUploadStarted: "onUploadStarted", onValidationError: "onValidationError" }, exportAs: ["smart-file-upload"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FileUploadComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }]; }, propDecorators: { accept: [{
                type: Input
            }], animation: [{
                type: Input
            }], appendTo: [{
