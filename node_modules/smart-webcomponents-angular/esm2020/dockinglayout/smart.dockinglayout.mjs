...
export class DockingLayoutComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
DockingLayoutComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
DockingLayoutComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: DockingLayoutComponent, selector: "smart-docking-layout, [smart-docking-layout]", inputs: { animation: "animation", autoHideItems: "autoHideItems", autoLoadState: "autoLoadState", autoSaveState: "autoSaveState", disabled: "disabled", draggable: "draggable", floatable: "floatable", hideSplitterBars: "hideSplitterBars", items: "items", closedItems: "closedItems", layout: "layout", liveResize: "liveResize", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", readonly: "readonly", rightToLeft: "rightToLeft", resizeStep: "resizeStep", snapMode: "snapMode", theme: "theme", undockedItems: "undockedItems", unfocusable: "unfocusable" }, outputs: { onChange: "onChange", onClose: "onClose", onClosing: "onClosing", onStateChange: "onStateChange", onResizeStart: "onResizeStart", onResizeEnd: "onResizeEnd" }, exportAs: ["smart-docking-layout"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutComponent, decorators: [{
            type: Directive,
            args: [{
