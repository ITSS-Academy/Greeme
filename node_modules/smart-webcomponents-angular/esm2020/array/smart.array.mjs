...
export class ArrayComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
ArrayComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
ArrayComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: ArrayComponent, selector: "smart-array, [smart-array]", inputs: { animation: "animation", arrayIndexingMode: "arrayIndexingMode", changeProperty: "changeProperty", columns: "columns", customWidgetDefaultValue: "customWidgetDefaultValue", dimensions: "dimensions", disabled: "disabled", elementHeight: "elementHeight", elementTemplate: "elementTemplate", elementWidth: "elementWidth", getElementValue: "getElementValue", indexerHeight: "indexerHeight", indexerWidth: "indexerWidth", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", readonly: "readonly", rows: "rows", setElementValue: "setElementValue", showHorizontalScrollbar: "showHorizontalScrollbar", showIndexDisplay: "showIndexDisplay", showSelection: "showSelection", showVerticalScrollbar: "showVerticalScrollbar", theme: "theme", type: "type", unfocusable: "unfocusable", value: "value" }, outputs: { onArraySizeChange: "onArraySizeChange", onChange: "onChange", onDimensionChange: "onDimensionChange", onElementClick: "onElementClick", onScroll: "onScroll", onSizeChange: "onSizeChange" }, exportAs: ["smart-array"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayComponent, decorators: [{
            type: Directive,
            args: [{
