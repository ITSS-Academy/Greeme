...
export declare class DateInputComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges, ControlValueAccessor {
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<DateInputComponent, "smart-date-input, [smart-date-input]", ["smart-date-input"], { "autoClose": "autoClose"; "autoCloseDelay": "autoCloseDelay"; "dateTimeFormat": "dateTimeFormat"; "disabled": "disabled"; "dropDownButtonPosition": "dropDownButtonPosition"; "dropDownHeight": "dropDownHeight"; "dropDownWidth": "dropDownWidth"; "formatString": "formatString"; "inputPurpose": "inputPurpose"; "locale": "locale"; "localizeFormatFunction": "localizeFormatFunction"; "max": "max"; "messages": "messages"; "min": "min"; "name": "name"; "opened": "opened"; "placeholder": "placeholder"; "readonly": "readonly"; "rightToLeft": "rightToLeft"; "theme": "theme"; "unfocusable": "unfocusable"; "value": "value"; }, { "onChange": "onChange"; }, never>;
}
