...
class DockingLayoutComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
class DockingLayoutModule {
}
DockingLayoutModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DockingLayoutModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutModule, declarations: [DockingLayoutComponent], exports: [DockingLayoutComponent] });
DockingLayoutModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DockingLayoutModule, decorators: [{
            type: NgModule,
            args: [{
...
export { DockingLayoutComponent, DockingLayoutModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-dockinglayout.mjs.map
