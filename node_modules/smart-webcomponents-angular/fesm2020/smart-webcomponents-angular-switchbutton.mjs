...
class SwitchButtonComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
SwitchButtonComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
SwitchButtonComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: SwitchButtonComponent, selector: "smart-switch-button, [smart-switch-button]", inputs: { animation: "animation", clickMode: "clickMode", checked: "checked", disabled: "disabled", falseContent: "falseContent", falseTemplate: "falseTemplate", indeterminate: "indeterminate", inverted: "inverted", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", name: "name", orientation: "orientation", readonly: "readonly", trueContent: "trueContent", trueTemplate: "trueTemplate", switchMode: "switchMode", theme: "theme", unfocusable: "unfocusable", value: "value" }, outputs: { onChange: "onChange", onCheckValue: "onCheckValue", onUncheckValue: "onUncheckValue" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-switch-button"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonComponent, decorators: [{
            type: Directive,
            args: [{
...
SwitchButtonModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
SwitchButtonModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonModule, declarations: [SwitchButtonComponent], exports: [SwitchButtonComponent] });
SwitchButtonModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: SwitchButtonModule, decorators: [{
            type: NgModule,
            args: [{
...
export { Smart, SwitchButtonComponent, SwitchButtonModule };
//# sourceMappingURL=smart-webcomponents-angular-switchbutton.mjs.map
