...
ChipComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: ChipComponent, selector: "smart-chip, [smart-chip]", inputs: { animation: "animation", avatar: "avatar", closeButton: "closeButton", disabled: "disabled", itemTemplate: "itemTemplate", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", readonly: "readonly", rightToLeft: "rightToLeft", theme: "theme", unfocusable: "unfocusable", value: "value" }, outputs: { onClose: "onClose" }, exportAs: ["smart-chip"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
