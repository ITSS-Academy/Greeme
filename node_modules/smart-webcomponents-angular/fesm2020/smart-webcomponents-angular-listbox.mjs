...
class ListBoxComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
ListBoxComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ListBoxComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
ListBoxComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: ListBoxComponent, selector: "smart-list-box, [smart-list-box]", inputs: { allowDrag: "allowDrag", allowDrop: "allowDrop", alternationCount: "alternationCount", alternationEnd: "alternationEnd", alternationStart: "alternationStart", animation: "animation", autoSort: "autoSort", dataSource: "dataSource", disabled: "disabled", displayLoadingIndicator: "displayLoadingIndicator", displayMember: "displayMember", dragFeedbackFormatFunction: "dragFeedbackFormatFunction", dragOffset: "dragOffset", dropAction: "dropAction", editable: "editable", filterable: "filterable", filterCallback: "filterCallback", filterMode: "filterMode", filterInputPlaceholder: "filterInputPlaceholder", grouped: "grouped", groupMember: "groupMember", horizontalScrollBarVisibility: "horizontalScrollBarVisibility", incrementalSearchDelay: "incrementalSearchDelay", incrementalSearchMode: "incrementalSearchMode", itemHeight: "itemHeight", itemMeasureMode: "itemMeasureMode", items: "items", itemTemplate: "itemTemplate", loadingIndicatorPlaceholder: "loadingIndicatorPlaceholder", loadingIndicatorPosition: "loadingIndicatorPosition", locale: "locale", localizeFormatFunction: "localizeFormatFunction", messages: "messages", name: "name", placeholder: "placeholder", readonly: "readonly", rightToLeft: "rightToLeft", selectedIndexes: "selectedIndexes", selectedValues: "selectedValues", selectionMode: "selectionMode", selectionChangeAction: "selectionChangeAction", sorted: "sorted", sortDirection: "sortDirection", theme: "theme", topVisibleIndex: "topVisibleIndex", unfocusable: "unfocusable", value: "value", valueMember: "valueMember", verticalScrollBarVisibility: "verticalScrollBarVisibility", virtualized: "virtualized" }, outputs: { onBindingComplete: "onBindingComplete", onChange: "onChange", onDragEnd: "onDragEnd", onDragging: "onDragging", onDragStart: "onDragStart", onItemClick: "onItemClick", onItemLabelChange: "onItemLabelChange", onScrollBottomReached: "onScrollBottomReached", onScrollTopReached: "onScrollTopReached", onSwipeleft: "onSwipeleft", onSwiperight: "onSwiperight" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-list-box"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ListBoxComponent, decorators: [{
            type: Directive,
            args: [{
...
ListBoxModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ListBoxModule, declarations: [ListBoxComponent, ListItemComponent, ListItemsGroupComponent], exports: [ListBoxComponent, ListItemComponent, ListItemsGroupComponent] });
ListBoxModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ListBoxModule });
...
export { ListBoxComponent, ListBoxModule, ListItemComponent, ListItemsGroupComponent, Smart };
//# sourceMappingURL=smart-webcomponents-angular-listbox.mjs.map
