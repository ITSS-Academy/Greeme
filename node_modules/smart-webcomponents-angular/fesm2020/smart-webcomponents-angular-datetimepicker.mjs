...
class DateTimePickerComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
DateTimePickerComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
DateTimePickerComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: DateTimePickerComponent, selector: "smart-date-time-picker, [smart-date-time-picker]", inputs: { animation: "animation", animationSettings: "animationSettings", autoClose: "autoClose", autoCloseDelay: "autoCloseDelay", calendarButton: "calendarButton", calendarButtonPosition: "calendarButtonPosition", calendarMode: "calendarMode", dayNameFormat: "dayNameFormat", disabled: "disabled", disableAutoNavigation: "disableAutoNavigation", displayKind: "displayKind", displayModeView: "displayModeView", dropDownAppendTo: "dropDownAppendTo", dropDownDisplayMode: "dropDownDisplayMode", dropDownOverlay: "dropDownOverlay", dropDownPosition: "dropDownPosition", editMode: "editMode", enableMouseWheelAction: "enableMouseWheelAction", firstDayOfWeek: "firstDayOfWeek", footerTemplate: "footerTemplate", footer: "footer", formatString: "formatString", headerTemplate: "headerTemplate", hideDayNames: "hideDayNames", hideOtherMonthDays: "hideOtherMonthDays", hideTooltipArrow: "hideTooltipArrow", hint: "hint", importantDates: "importantDates", importantDatesTemplate: "importantDatesTemplate", interval: "interval", label: "label", locale: "locale", localizeFormatFunction: "localizeFormatFunction", max: "max", messages: "messages", min: "min", name: "name", nullable: "nullable", opened: "opened", placeholder: "placeholder", readonly: "readonly", restrictedDates: "restrictedDates", rightToLeft: "rightToLeft", spinButtons: "spinButtons", spinButtonsDelay: "spinButtonsDelay", spinButtonsInitialDelay: "spinButtonsInitialDelay", spinButtonsPosition: "spinButtonsPosition", theme: "theme", tooltip: "tooltip", tooltipDelay: "tooltipDelay", tooltipPosition: "tooltipPosition", tooltipTemplate: "tooltipTemplate", unfocusable: "unfocusable", validation: "validation", value: "value", weekNumbers: "weekNumbers", weeks: "weeks", yearCutoff: "yearCutoff" }, outputs: { onChange: "onChange", onClose: "onClose", onClosing: "onClosing", onOpen: "onOpen", onOpening: "onOpening" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-date-time-picker"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerComponent, decorators: [{
            type: Directive,
            args: [{
...
DateTimePickerModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DateTimePickerModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerModule, declarations: [DateTimePickerComponent], exports: [DateTimePickerComponent] });
DateTimePickerModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateTimePickerModule, decorators: [{
            type: NgModule,
            args: [{
...
export { DateTimePickerComponent, DateTimePickerModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-datetimepicker.mjs.map
