...
class GanttChartComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
GanttChartComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
GanttChartComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: GanttChartComponent, selector: "smart-gantt-chart, [smart-gantt-chart]", inputs: { adjustToNonworkingTime: "adjustToNonworkingTime", autoSchedule: "autoSchedule", autoScheduleStrictMode: "autoScheduleStrictMode", autoScrollStep: "autoScrollStep", columnMenu: "columnMenu", columnResize: "columnResize", columnResizeFeedback: "columnResizeFeedback", currentTime: "currentTime", currentTimeIndicator: "currentTimeIndicator", currentTimeIndicatorInterval: "currentTimeIndicatorInterval", dataExport: "dataExport", dataSource: "dataSource", dayFormat: "dayFormat", dateEnd: "dateEnd", dateStart: "dateStart", dateMarkers: "dateMarkers", disabled: "disabled", disableAutoScroll: "disableAutoScroll", disableTaskDrag: "disableTaskDrag", disableTaskProgressChange: "disableTaskProgressChange", disableTaskResize: "disableTaskResize", disableSelection: "disableSelection", disableSegmentDrag: "disableSegmentDrag", disableSegmentResize: "disableSegmentResize", disableWindowEditor: "disableWindowEditor", durationUnit: "durationUnit", filterRow: "filterRow", firstDayOfWeek: "firstDayOfWeek", groupByResources: "groupByResources", headerTemplate: "headerTemplate", hideDateMarkers: "hideDateMarkers", hideTimelineHeader: "hideTimelineHeader", hideTimelineHeaderDetails: "hideTimelineHeaderDetails", hideTimelineSecondHeaderDetails: "hideTimelineSecondHeaderDetails", showSelectionColumn: "showSelectionColumn", hideResourcePanel: "hideResourcePanel", horizontalScrollBarVisibility: "horizontalScrollBarVisibility", hourFormat: "hourFormat", infiniteTimeline: "infiniteTimeline", infiniteTimelineStep: "infiniteTimelineStep", inverted: "inverted", keyboardNavigation: "keyboardNavigation", locale: "locale", max: "max", min: "min", messages: "messages", monthFormat: "monthFormat", monthScale: "monthScale", nonworkingDays: "nonworkingDays", nonworkingHours: "nonworkingHours", onTaskRender: "onTaskRender", popupWindowCustomizationFunction: "popupWindowCustomizationFunction", popupWindowTabs: "popupWindowTabs", progressLabelFormatFunction: "progressLabelFormatFunction", quarterFormat: "quarterFormat", resources: "resources", resourceColumns: "resourceColumns", resourceFiltering: "resourceFiltering", resourceGroupFormatFunction: "resourceGroupFormatFunction", resourcePanelHeaderTemplate: "resourcePanelHeaderTemplate", resourcePanelMin: "resourcePanelMin", resourcePanelSize: "resourcePanelSize", resourcePanelRefreshRate: "resourcePanelRefreshRate", resourceTimelineFormatFunction: "resourceTimelineFormatFunction", resourceTimelineMode: "resourceTimelineMode", resourceTimelineView: "resourceTimelineView", rightToLeft: "rightToLeft", selectedTaskIds: "selectedTaskIds", selectedResourceIds: "selectedResourceIds", shadeUntilCurrentTime: "shadeUntilCurrentTime", showBaseline: "showBaseline", showProgressLabel: "showProgressLabel", snapToNearest: "snapToNearest", sortFunction: "sortFunction", sortMode: "sortMode", tasks: "tasks", taskColumns: "taskColumns", taskFiltering: "taskFiltering", taskPanelMin: "taskPanelMin", taskPanelSize: "taskPanelSize", timelineMin: "timelineMin", treeMin: "treeMin", treeSize: "treeSize", timelineHeaderFormatFunction: "timelineHeaderFormatFunction", tooltip: "tooltip", verticalScrollBarVisibility: "verticalScrollBarVisibility", view: "view", yearFormat: "yearFormat", weekFormat: "weekFormat", theme: "theme", unfocusable: "unfocusable" }, outputs: { onBeginUpdate: "onBeginUpdate", onEndUpdate: "onEndUpdate", onConnectionStart: "onConnectionStart", onConnectionEnd: "onConnectionEnd", onChange: "onChange", onColumnResize: "onColumnResize", onClosing: "onClosing", onClose: "onClose", onCollapse: "onCollapse", onDragStart: "onDragStart", onDragEnd: "onDragEnd", onExpand: "onExpand", onFilter: "onFilter", onItemClick: "onItemClick", onItemInsert: "onItemInsert", onItemRemove: "onItemRemove", onItemUpdate: "onItemUpdate", onOpening: "onOpening", onOpen: "onOpen", onProgressChangeStart: "onProgressChangeStart", onProgressChangeEnd: "onProgressChangeEnd", onResizeStart: "onResizeStart", onResizeEnd: "onResizeEnd", onSort: "onSort", onScrollBottomReached: "onScrollBottomReached", onScrollTopReached: "onScrollTopReached", onScrollLeftReached: "onScrollLeftReached", onScrollRightReached: "onScrollRightReached" }, exportAs: ["smart-gantt-chart"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartComponent, decorators: [{
            type: Directive,
            args: [{
                    exportAs: 'smart-gantt-chart', selector: 'smart-gantt-chart, [smart-gantt-chart]'
                }]
        }], ctorParameters: function () { return [{ type: i0.ElementRef }]; }, propDecorators: { adjustToNonworkingTime: [{
                type: Input
            }], autoSchedule: [{
                type: Input
...
GanttChartModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
GanttChartModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartModule, declarations: [GanttChartComponent], exports: [GanttChartComponent] });
GanttChartModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GanttChartModule, decorators: [{
            type: NgModule,
            args: [{
...
export { GanttChartComponent, GanttChartModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-ganttchart.mjs.map
