...
class CardViewComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
CardViewComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
CardViewComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: CardViewComponent, selector: "smart-card-view, [smart-card-view]", inputs: { addNewButton: "addNewButton", allowDrag: "allowDrag", animation: "animation", cardHeight: "cardHeight", cellOrientation: "cellOrientation", collapsible: "collapsible", columns: "columns", coverField: "coverField", coverMode: "coverMode", dataSource: "dataSource", dataSourceSettings: "dataSourceSettings", editable: "editable", headerPosition: "headerPosition", locale: "locale", messages: "messages", rightToLeft: "rightToLeft", theme: "theme", scrolling: "scrolling", titleField: "titleField" }, outputs: { onFilter: "onFilter", onSort: "onSort", onOpen: "onOpen", onOpening: "onOpening", onClose: "onClose", onClosing: "onClosing", onDragStart: "onDragStart", onDragging: "onDragging", onDragEnd: "onDragEnd" }, exportAs: ["smart-card-view"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewComponent, decorators: [{
            type: Directive,
            args: [{
                    exportAs: 'smart-card-view', selector: 'smart-card-view, [smart-card-view]'
                }]
        }], ctorParameters: function () { return [{ type: i0.ElementRef }]; }, propDecorators: { addNewButton: [{
                type: Input
            }], allowDrag: [{
                type: Input
            }], animation: [{
...
CardViewModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CardViewModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewModule, declarations: [CardViewComponent], exports: [CardViewComponent] });
CardViewModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CardViewModule, decorators: [{
            type: NgModule,
            args: [{
...
export { CardViewComponent, CardViewModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-cardview.mjs.map
