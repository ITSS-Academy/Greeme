...
class ArrayComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
ArrayModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ArrayModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayModule, declarations: [ArrayComponent], exports: [ArrayComponent] });
ArrayModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ArrayModule, decorators: [{
            type: NgModule,
            args: [{
...
export { ArrayComponent, ArrayModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-array.mjs.map
