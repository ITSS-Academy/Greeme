...
class FormControlComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        this.nativeElement = ref.nativeElement;
...
class FormGroupComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        this.nativeElement = ref.nativeElement;
...
FormModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FormModule, declarations: [FormComponent, FormControlComponent, FormGroupComponent], exports: [FormComponent, FormControlComponent, FormGroupComponent] });
FormModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FormModule });
...
export { FormComponent, FormControlComponent, FormGroupComponent, FormModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-form.mjs.map
