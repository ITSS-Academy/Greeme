...
class CarouselComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
CarouselComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CarouselComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
CarouselComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: CarouselComponent, selector: "smart-carousel, [smart-carousel]", inputs: { animation: "animation", autoPlay: "autoPlay", dataSource: "dataSource", delay: "delay", disabled: "disabled", disableItemClick: "disableItemClick", displayMode: "displayMode", hideArrows: "hideArrows", hideIndicators: "hideIndicators", indicatorTemplate: "indicatorTemplate", interval: "interval", itemTemplate: "itemTemplate", keyboard: "keyboard", locale: "locale", localizeFormatFunction: "localizeFormatFunction", loop: "loop", messages: "messages", readonly: "readonly", rightToLeft: "rightToLeft", slideShow: "slideShow", swipe: "swipe", theme: "theme", unfocusable: "unfocusable", wheel: "wheel" }, outputs: { onChange: "onChange", onChanging: "onChanging", onSwipeleft: "onSwipeleft", onSwiperight: "onSwiperight" }, exportAs: ["smart-carousel"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
...
CarouselModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CarouselModule, declarations: [CarouselComponent], exports: [CarouselComponent] });
CarouselModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: CarouselModule });
...
export { CarouselComponent, CarouselModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-carousel.mjs.map
