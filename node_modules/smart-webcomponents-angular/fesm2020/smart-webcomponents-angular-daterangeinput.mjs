...
class DateRangeInputComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
DateRangeInputComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
DateRangeInputComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: DateRangeInputComponent, selector: "smart-date-range-input, [smart-date-range-input]", inputs: { animation: "animation", dateFormat: "dateFormat", disabled: "disabled", dropDownButtonPosition: "dropDownButtonPosition", dropDownHeight: "dropDownHeight", dropDownWidth: "dropDownWidth", icons: "icons", inputPurpose: "inputPurpose", locale: "locale", localizeFormatFunction: "localizeFormatFunction", max: "max", messages: "messages", min: "min", months: "months", name: "name", opened: "opened", placeholder: "placeholder", readonly: "readonly", rightToLeft: "rightToLeft", separator: "separator", timeFormat: "timeFormat", timepicker: "timepicker", theme: "theme", unfocusable: "unfocusable", value: "value", valueType: "valueType" }, outputs: { onChange: "onChange" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-date-range-input"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputComponent, decorators: [{
            type: Directive,
            args: [{
...
class DateRangeInputModule {
}
DateRangeInputModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
DateRangeInputModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputModule, declarations: [DateRangeInputComponent], exports: [DateRangeInputComponent] });
DateRangeInputModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: DateRangeInputModule, decorators: [{
            type: NgModule,
            args: [{
...
export { DateRangeInputComponent, DateRangeInputModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-daterangeinput.mjs.map
