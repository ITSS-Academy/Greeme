...
class MaskedTextBoxComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
MaskedTextBoxComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
MaskedTextBoxComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: MaskedTextBoxComponent, selector: "smart-masked-text-box, [smart-masked-text-box]", inputs: { animation: "animation", allowPromptAsInput: "allowPromptAsInput", asciiOnly: "asciiOnly", autoFocus: "autoFocus", autoShowMask: "autoShowMask", cutCopyMaskFormat: "cutCopyMaskFormat", disabled: "disabled", enterKeyBehavior: "enterKeyBehavior", hidePromptOnLeave: "hidePromptOnLeave", hint: "hint", isOverwriteMode: "isOverwriteMode", label: "label", locale: "locale", localizeFormatFunction: "localizeFormatFunction", mask: "mask", maskCompleted: "maskCompleted", maskFull: "maskFull", maxLength: "maxLength", messages: "messages", name: "name", placeholder: "placeholder", promptChar: "promptChar", readonly: "readonly", rejectInputOnFirstFailure: "rejectInputOnFirstFailure", required: "required", resetOnPrompt: "resetOnPrompt", resetOnSpace: "resetOnSpace", rightToLeft: "rightToLeft", selectAllOnFocus: "selectAllOnFocus", textMaskFormat: "textMaskFormat", theme: "theme", unfocusable: "unfocusable", value: "value", validation: "validation" }, outputs: { onChange: "onChange", onChanging: "onChanging", onValidation: "onValidation" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-masked-text-box"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxComponent, decorators: [{
            type: Directive,
            args: [{
...
MaskedTextBoxModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
MaskedTextBoxModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxModule, declarations: [MaskedTextBoxComponent], exports: [MaskedTextBoxComponent] });
MaskedTextBoxModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MaskedTextBoxModule, decorators: [{
            type: NgModule,
            args: [{
...
export { MaskedTextBoxComponent, MaskedTextBoxModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-maskedtextbox.mjs.map
