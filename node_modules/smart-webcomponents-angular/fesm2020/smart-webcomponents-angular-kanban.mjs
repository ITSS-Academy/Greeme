...
KanbanComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
KanbanComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: KanbanComponent, selector: "smart-kanban, [smart-kanban]", inputs: { allowColumnReorder: "allowColumnReorder", allowColumnEdit: "allowColumnEdit", allowColumnRemove: "allowColumnRemove", allowColumnHide: "allowColumnHide", addNewButton: "addNewButton", addNewButtonDisplayMode: "addNewButtonDisplayMode", addNewColumn: "addNewColumn", addNewColumnWidth: "addNewColumnWidth", allowDrag: "allowDrag", allowDrop: "allowDrop", applyColumnColorToTasks: "applyColumnColorToTasks", autoLoadState: "autoLoadState", autoSaveState: "autoSaveState", autoColumnHeight: "autoColumnHeight", collapsible: "collapsible", columnColors: "columnColors", columnWidth: "columnWidth", columnColorEntireSurface: "columnColorEntireSurface", columnFooter: "columnFooter", columns: "columns", columnActions: "columnActions", columnSummary: "columnSummary", columnHeaderTemplate: "columnHeaderTemplate", columnEditMode: "columnEditMode", currentUser: "currentUser", disableDialog: "disableDialog", dialogCustomizationFunction: "dialogCustomizationFunction", dialogRendered: "dialogRendered", dataSource: "dataSource", dataSourceMap: "dataSourceMap", dragOffset: "dragOffset", editable: "editable", formatStringDate: "formatStringDate", formatStringTime: "formatStringTime", headerPosition: "headerPosition", hierarchy: "hierarchy", locale: "locale", messages: "messages", onTaskRender: "onTaskRender", onFilterPrepare: "onFilterPrepare", onSortPrepare: "onSortPrepare", onColumnHeaderRender: "onColumnHeaderRender", onColumnFooterRender: "onColumnFooterRender", selectionMode: "selectionMode", storeHistory: "storeHistory", storeHistoryItems: "storeHistoryItems", rightToLeft: "rightToLeft", readonly: "readonly", swimlanes: "swimlanes", swimlanesFrom: "swimlanesFrom", swimlanesTo: "swimlanesTo", tags: "tags", taskActions: "taskActions", taskActionsRendered: "taskActionsRendered", taskComments: "taskComments", taskDue: "taskDue", taskPosition: "taskPosition", taskPriority: "taskPriority", taskProgress: "taskProgress", taskCustomFields: "taskCustomFields", taskColorEntireSurface: "taskColorEntireSurface", taskSubTasksInput: "taskSubTasksInput", taskSubTasks: "taskSubTasks", taskTags: "taskTags", taskUserIcon: "taskUserIcon", textTemplate: "textTemplate", theme: "theme", priorityList: "priorityList", priority: "priority", userList: "userList", users: "users" }, outputs: { onChange: "onChange", onClose: "onClose", onClosing: "onClosing", onColumnAdd: "onColumnAdd", onColumnRemove: "onColumnRemove", onColumnReorder: "onColumnReorder", onColumnUpdate: "onColumnUpdate", onColumnClick: "onColumnClick", onColumnDoubleClick: "onColumnDoubleClick", onColumnShow: "onColumnShow", onColumnHide: "onColumnHide", onColumnCollapse: "onColumnCollapse", onColumnExpand: "onColumnExpand", onCommentAdd: "onCommentAdd", onCommentRemove: "onCommentRemove", onCommentUpdate: "onCommentUpdate", onDragEnd: "onDragEnd", onDragging: "onDragging", onDragStart: "onDragStart", onFilter: "onFilter", onOpen: "onOpen", onOpening: "onOpening", onSort: "onSort", onTaskBeforeAdd: "onTaskBeforeAdd", onTaskAdd: "onTaskAdd", onTaskRemove: "onTaskRemove", onTaskUpdate: "onTaskUpdate", onTaskClick: "onTaskClick", onTaskDoubleClick: "onTaskDoubleClick" }, exportAs: ["smart-kanban"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanComponent, decorators: [{
            type: Directive,
            args: [{
                    exportAs: 'smart-kanban', selector: 'smart-kanban, [smart-kanban]'
                }]
        }], ctorParameters: function () { return [{ type: i0.ElementRef }]; }, propDecorators: { allowColumnReorder: [{
                type: Input
            }], allowColumnEdit: [{
                type: Input
            }], allowColumnRemove: [{
...
KanbanModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
KanbanModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanModule, declarations: [KanbanComponent], exports: [KanbanComponent] });
KanbanModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: KanbanModule, decorators: [{
            type: NgModule,
            args: [{
...
export { KanbanComponent, KanbanModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-kanban.mjs.map
