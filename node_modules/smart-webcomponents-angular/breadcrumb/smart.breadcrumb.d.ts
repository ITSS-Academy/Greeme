...
export declare class BreadcrumbComponent extends BaseElement implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    */
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<BreadcrumbComponent, "smart-breadcrumb, [smart-breadcrumb]", ["smart-breadcrumb"], { "addNewItem": "addNewItem"; "allowDrag": "allowDrag"; "allowDrop": "allowDrop"; "animation": "animation"; "closeButtons": "closeButtons"; "dataSource": "dataSource"; "disabled": "disabled"; "itemTemplate": "itemTemplate"; "locale": "locale"; "messages": "messages"; "minimizeWidth": "minimizeWidth"; "unfocusable": "unfocusable"; }, { "onClose": "onClose"; "onClosing": "onClosing"; "onDragEnd": "onDragEnd"; "onDragging": "onDragging"; "onAddNewItem": "onAddNewItem"; }, never>;
}
