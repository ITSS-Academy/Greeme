...
class GroupPanelComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
GroupPanelComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
GroupPanelComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: GroupPanelComponent, selector: "smart-group-panel, [smart-group-panel]", inputs: { animation: "animation", closeButtonPosition: "closeButtonPosition", dataSource: "dataSource", disabled: "disabled", locale: "locale", localizeFormatFunction: "localizeFormatFunction", maxLevel: "maxLevel", messages: "messages", readonly: "readonly", rightToLeft: "rightToLeft", unfocusable: "unfocusable" }, outputs: { onApply: "onApply", onCancel: "onCancel", onCollapseAll: "onCollapseAll", onExpandAll: "onExpandAll" }, exportAs: ["smart-group-panel"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelComponent, decorators: [{
            type: Directive,
            args: [{
...
class GroupPanelModule {
}
GroupPanelModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
GroupPanelModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelModule, declarations: [GroupPanelComponent], exports: [GroupPanelComponent] });
GroupPanelModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: GroupPanelModule, decorators: [{
            type: NgModule,
            args: [{
...
export { GroupPanelComponent, GroupPanelModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-grouppanel.mjs.map
