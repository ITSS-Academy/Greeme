...
EditorComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: EditorComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
EditorComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: EditorComponent, selector: "smart-editor, [smart-editor]", inputs: { animation: "animation", autoLoad: "autoLoad", autoSave: "autoSave", autoSaveInterval: "autoSaveInterval", charCountFormatFunction: "charCountFormatFunction", autoUpload: "autoUpload", contentFiltering: "contentFiltering", contextMenu: "contextMenu", contextMenuDataSource: "contextMenuDataSource", dataExport: "dataExport", disabled: "disabled", disableEditing: "disableEditing", disableSearchBar: "disableSearchBar", editMode: "editMode", enableHtmlEncode: "enableHtmlEncode", enableTabKey: "enableTabKey", findAndReplaceTimeout: "findAndReplaceTimeout", hideToolbar: "hideToolbar", hideInlineToolbar: "hideInlineToolbar", imageFormat: "imageFormat", innerHTML: "innerHTML", inlineToolbarOffset: "inlineToolbarOffset", iframeSettings: "iframeSettings", locale: "locale", maxCharCount: "maxCharCount", messages: "messages", name: "name", pasteFormat: "pasteFormat", placeholder: "placeholder", removeStylesOnClearFormat: "removeStylesOnClearFormat", required: "required", rightToLeft: "rightToLeft", sanitized: "sanitized", showCharCount: "showCharCount", spellCheck: "spellCheck", splitModeRefreshTimeout: "splitModeRefreshTimeout", uploadUrl: "uploadUrl", removeUrl: "removeUrl", theme: "theme", toolbarItems: "toolbarItems", toolbarMode: "toolbarMode", toolbarRibbonConfig: "toolbarRibbonConfig", toolbarViewMode: "toolbarViewMode", toolbarSticky: "toolbarSticky", unfocusable: "unfocusable", value: "value", windowCustomizationFunction: "windowCustomizationFunction" }, outputs: { onChange: "onChange", onChanging: "onChanging", onActionStart: "onActionStart", onActionEnd: "onActionEnd", onContextMenuItemClick: "onContextMenuItemClick", onContextMenuOpen: "onContextMenuOpen", onContextMenuOpening: "onContextMenuOpening", onContextMenuClose: "onContextMenuClose", onContextMenuClosing: "onContextMenuClosing", onResizeStart: "onResizeStart", onResizeEnd: "onResizeEnd", onInlineToolbarOpen: "onInlineToolbarOpen", onInlineToolbarOpening: "onInlineToolbarOpening", onInlineToolbarClose: "onInlineToolbarClose", onInlineToolbarClosing: "onInlineToolbarClosing", onDropDownToolbarOpen: "onDropDownToolbarOpen", onDropDownToolbarOpening: "onDropDownToolbarOpening", onDropDownToolbarClose: "onDropDownToolbarClose", onDropDownToolbarClosing: "onDropDownToolbarClosing", onDialogOpen: "onDialogOpen", onDialogOpening: "onDialogOpening", onDialogClose: "onDialogClose", onDialogClosing: "onDialogClosing", onImageUploadSuccess: "onImageUploadSuccess", onImageUploadFailed: "onImageUploadFailed", onToobarItemClick: "onToobarItemClick", onMessageClose: "onMessageClose", onMessageOpen: "onMessageOpen" }, exportAs: ["smart-editor"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: EditorComponent, decorators: [{
            type: Directive,
            args: [{
                ...
                type: Output
            }], onInlineToolbarClose: [{
                type: Output
            }], onInlineToolbarClosing: [{
                type: Output
            }], onDropDownToolbarOpen: [{
                type: Output
            }], onDropDownToolbarOpening: [{
                type: Output
            }], onDropDownToolbarClose: [{
                type: Output
            }], onDropDownToolbarClosing: [{
                type: Output
            }], onDialogOpen: [{
                type: Output
            }], onDialogOpening: [{
...
EditorModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: EditorModule, declarations: [EditorComponent], exports: [EditorComponent] });
EditorModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: EditorModule });
...
export { EditorComponent, EditorModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-editor.mjs.map
