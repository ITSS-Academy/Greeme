...
class AccordionItemComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
AccordionItemComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: AccordionItemComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
AccordionItemComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: AccordionItemComponent, selector: "smart-accordion-item, [smart-accordion-item]", inputs: { arrow: "arrow", content: "content", expanded: "expanded", focused: "focused", label: "label" }, outputs: { onCollapse: "onCollapse", onExpand: "onExpand" }, exportAs: ["smart-accordion-item"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: AccordionItemComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.ElementRef }]; }, propDecorators: { arrow: [{
                type: Input
            }], content: [{
                type: Input
            }], expanded: [{
...
AccordionModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: AccordionModule, declarations: [AccordionComponent, AccordionItemComponent], exports: [AccordionComponent, AccordionItemComponent] });
AccordionModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: AccordionModule });
...
export { AccordionComponent, AccordionItemComponent, AccordionModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-accordion.mjs.map
