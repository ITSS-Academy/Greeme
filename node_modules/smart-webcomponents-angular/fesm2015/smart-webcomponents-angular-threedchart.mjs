...
class ThreeDChartComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
class ThreeDChartModule {
}
ThreeDChartModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ThreeDChartModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ThreeDChartModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ThreeDChartModule, declarations: [ThreeDChartComponent], exports: [ThreeDChartComponent] });
ThreeDChartModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ThreeDChartModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ThreeDChartModule, decorators: [{
            type: NgModule,
            args: [{
...
export { Smart, ThreeDChartComponent, ThreeDChartModule };
//# sourceMappingURL=smart-webcomponents-angular-threedchart.mjs.map
