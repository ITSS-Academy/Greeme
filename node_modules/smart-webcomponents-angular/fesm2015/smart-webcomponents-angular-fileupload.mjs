...
class FileUploadComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
...
FileUploadModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FileUploadModule, declarations: [FileUploadComponent], exports: [FileUploadComponent] });
FileUploadModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: FileUploadModule });
...
export { FileUploadComponent, FileUploadModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-fileupload.mjs.map
