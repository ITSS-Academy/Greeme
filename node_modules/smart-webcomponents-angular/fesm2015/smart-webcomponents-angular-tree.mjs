...
class TreeItemComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        this.nativeElement = ref.nativeElement;
...
TreeItemComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: TreeItemComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
TreeItemComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: TreeItemComponent, selector: "smart-tree-item, [smart-tree-item]", inputs: { disabled: "disabled", label: "label", level: "level", selected: "selected", separator: "separator", shortcut: "shortcut", value: "value", readonly: "readonly" }, exportAs: ["smart-tree-item"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: TreeItemComponent, decorators: [{
            type: Directive,
            args: [{
...
class TreeItemsGroupComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        this.nativeElement = ref.nativeElement;
...
TreeModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: TreeModule, declarations: [TreeComponent, TreeItemComponent, TreeItemsGroupComponent], exports: [TreeComponent, TreeItemComponent, TreeItemsGroupComponent] });
TreeModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: TreeModule });
...
export { Smart, TreeComponent, TreeItemComponent, TreeItemsGroupComponent, TreeModule };
//# sourceMappingURL=smart-webcomponents-angular-tree.mjs.map
