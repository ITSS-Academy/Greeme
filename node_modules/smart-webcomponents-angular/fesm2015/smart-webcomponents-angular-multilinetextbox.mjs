...
class MultilineTextBoxComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
MultilineTextBoxComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxComponent, deps: [{ token: i0.ElementRef }], target: i0.ɵɵFactoryTarget.Directive });
MultilineTextBoxComponent.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "13.2.6", type: MultilineTextBoxComponent, selector: "smart-multiline-text-box, [smart-multiline-text-box]", inputs: { animation: "animation", autoCapitalize: "autoCapitalize", autoComplete: "autoComplete", autoExpand: "autoExpand", autoFocus: "autoFocus", cols: "cols", disabled: "disabled", displayMode: "displayMode", enterKeyBehavior: "enterKeyBehavior", form: "form", hint: "hint", horizontalScrollBarVisibility: "horizontalScrollBarVisibility", inputPurpose: "inputPurpose", label: "label", locale: "locale", localizeFormatFunction: "localizeFormatFunction", maxLength: "maxLength", minLength: "minLength", messages: "messages", name: "name", placeholder: "placeholder", readonly: "readonly", required: "required", resizable: "resizable", rightToLeft: "rightToLeft", rows: "rows", selectAllOnFocus: "selectAllOnFocus", selectionEnd: "selectionEnd", selectionStart: "selectionStart", spellCheck: "spellCheck", theme: "theme", unfocusable: "unfocusable", value: "value", verticalScrollBarVisibility: "verticalScrollBarVisibility", wrap: "wrap" }, outputs: { onChange: "onChange" }, providers: [CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR], exportAs: ["smart-multiline-text-box"], usesInheritance: true, usesOnChanges: true, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxComponent, decorators: [{
            type: Directive,
            args: [{
...
class MultilineTextBoxModule {
}
MultilineTextBoxModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
MultilineTextBoxModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxModule, declarations: [MultilineTextBoxComponent, ListItemComponent, ListItemsGroupComponent], exports: [MultilineTextBoxComponent, ListItemComponent, ListItemsGroupComponent] });
MultilineTextBoxModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: MultilineTextBoxModule, decorators: [{
            type: NgModule,
            args: [{
...
export { ListItemComponent, ListItemsGroupComponent, MultilineTextBoxComponent, MultilineTextBoxModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-multilinetextbox.mjs.map
