...
class ColorInputComponent extends BaseElement {
    constructor(ref) {
        super(ref);
        this.eventHandlers = [];
        /**
...
class ColorInputModule {
}
ColorInputModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ColorInputModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
ColorInputModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ColorInputModule, declarations: [ColorInputComponent], exports: [ColorInputComponent] });
ColorInputModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ColorInputModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.6", ngImport: i0, type: ColorInputModule, decorators: [{
            type: NgModule,
            args: [{
...
export { ColorInputComponent, ColorInputModule, Smart };
//# sourceMappingURL=smart-webcomponents-angular-colorinput.mjs.map
